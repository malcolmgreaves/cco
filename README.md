...
- `--auto`: Starts `claude` with `--permission-mode auto`, enabling Opus 4.7's auto mode (continuous execution with Claude's own permission intelligence). Replaces the default `--dangerously-skip-permissions`.
